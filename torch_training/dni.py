...
Copied from: ~/src/dni-pytorch
Original paper: Jaderberg et al. (2017) - Decoupled Neural Interfaces using Synthetic Gradients
License: MIT

This implementation enables update and forward unlocking for neural networks
by using synthetic gradients and activations.
"""
